...
This script generates one of those headers for each additional bid provided as a
base64url-encoded argument in the GET request. All requests to this endpoint
...
def main(request, response):
  try:
    ...
    auction_nonce = request.GET.get(b"auctionNonce", default=b"").decode("utf-8")
    if not auction_nonce:
      raise BadRequestError("Missing 'auctionNonce' parameter")
